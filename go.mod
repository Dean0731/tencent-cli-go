module github.com/dean0731/tencent-cli-go

go 1.23.7

//replace github.com/dean0731/dean-tool => E:\Workspace\GoWorkSpace\dean-tool

require (
	github.com/dean0731/dean-tool v0.0.0-20251109073119-d9344ac22622
